	...
	render: function () {
            ...
            return (
                React.createElement("div", {className: "exam form-group"},
                    React.createElement("h1", null, "Exam Maker"),
                    ...
                    React.createElement("div", {className: "exam-header"},
                        ...
                        React.createElement("div", {className: "exam-header"},
                            React.createElement("textarea", {value: this.state.testDescription, cols: 50, onChange: this.handleDescriptionChange})
                        )
                    ),                    
                    React.createElement("div", {className: "exam-header"},
                    ...
                    React.createElement("div", {className: "exam-header"},
                        ...
                        React.createElement("div", {className: "exam-header"},
                            React.createElement("select", {value: this.state.courseSelected, onChange: this.handleCourseChange}, 
                    ...
                    React.createElement("div",{className: "pull-right"}, React.createElement("a", {href: "${user}#/manage_exam", className:"pull-right"}, "Exams List")),
                    ...
                    React.createElement("div",{className: "pull-right"}, React.createElement("a", {href: "${user}#/manage_courses", className:"pull-right"}, "Courses List"))
                )
            );
	}
    });    
