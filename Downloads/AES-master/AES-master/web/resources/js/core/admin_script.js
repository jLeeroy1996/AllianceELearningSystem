(function() {
	'use strict';       
        ...
        var app = angular.module('ELearningApp', ['ngSanitize', 'ui.tinymce', 'ngRoute']);
        ...
        app.config( ['$routeProvider', function($routeProvider) {
            $routeProvider                
                ...
                .when('/manage_users', {
                    templateUrl: 'templates/admin/manage_users.html',
                    controller: 'ManageUserController'
                })
                .when('/add_course', {
                    templateUrl: 'templates/admin/add_course.html', 
                    controller: 'AddCourseController'
                })
                .when('/manage_courses', {
                    templateUrl: 'templates/admin/manage_courses.html',
                    controller: 'ManageCourseController'
                })
                .when('/manage_exam', {
                    templateUrl: 'templates/admin/manage_exam.html',
                    controller: 'ManageExamController'
                })
                .when('/exam_results', {
                    templateUrl: 'templates/admin/exam_results.html',
                    controller: 'ExamResultsController'            
                })
                .when('/business_unit', {
                    templateUrl: 'templates/admin/business_unit.html',
                    controller: 'ManageBusinessUnitController'
                })
                .when('/course_category', {
                    templateUrl: 'templates/admin/course_category.html',
                ...
                .when('/update_profile', {
                    templateUrl: 'templates/admin/update_profile.html',
                ...
                .when('/course_details', {
                    templateUrl: 'templates/admin/course_details.html',
                    controller: 'CourseDetailsController'
                })
                .when('/add_chapter', {
                    templateUrl: 'templates/admin/add_chapter.html',
                ...
                if ($scope.courseSelected != 0) {
                    ...
                    $http.post('post/chapter', data).success(function(response){
                        if (response.error == ""){
                            ...
                            window.location.href = "admin#/course_details?id=" + data.course;
                        } else {
        ...
        app.controller('CourseDetailsController', ['$scope', '$routeParams', '$http', 'fileUpload', function($scope, $routeParams, $http, fileUpload) {                                    
            ...
            $scope.goToAddChapter = function (id) {
                window.location.href = "admin#/add_chapter?id=" + id;
            };
        ...
        app.controller('ManageCourseController', ['$scope', '$http', '$window', function($scope, $http, $window) {            
            ...
            $scope.goToAddCourse = function () {
                window.location.href = "admin#/add_course";
            };
            
            $scope.viewCourse = function (id) {
                window.location.href = "admin#/course_details?id=" + id;
            };
